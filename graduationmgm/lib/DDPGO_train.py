...
class DDPGOTrain(BaseTrain):
    def __init__(self, static_policy=False, env=None,
                 config=None):
        super(DDPGOTrain, self).__init__(config=config, env=env)
        ...
        self.writer = SummaryWriter(
            f'./saved_agents/DDPGO/agent_{self.env.getUnum()}')
    ...
    def update(self):  # faster
        ...
        self.writer.add_scalar('Loss/ddpgo/critic_loss', critic_loss,
        ...
        self.writer.add_scalar(
            'Loss/ddpgo/actor_loss', actor_loss, global_step=self.num_actor_update_iteration)
